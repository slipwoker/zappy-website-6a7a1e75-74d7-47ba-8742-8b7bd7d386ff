  ...
  function validateField(field) {
    ...
    if (value !== '') {
      if (type === 'email' && !validateEmail(value)) {
        ...
        showFieldError(field, field.dataset.errorTel || 'Please enter a valid phone number.');
        isValid = false;
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '6a7a1e75-74d7-47ba-8742-8b7bd7d386ff',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '6a7a1e75-74d7-47ba-8742-8b7bd7d386ff';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '6a7a1e75-74d7-47ba-8742-8b7bd7d386ff';
